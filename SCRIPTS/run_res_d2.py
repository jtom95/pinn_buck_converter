...
from pinn_buck.data_noise_modeling.covariance_matrix_function_archive import covariance_matrix_on_residuals_d2, generate_residual_covariance_matrix, chol
from pinn_buck.model.trainer_auxiliary_functions import calculate_covariance_matrix, calculate_inflation_factor
from pinn_buck.model.residuals import residual_d2
...
for data_covariance in [(noise_power_ADC_i, noise_power_ADC_v), (noise_power_5_i, noise_power_5_v), (noise_power_10_i, noise_power_10_v)]:
    ...
    cov_matrix = generate_residual_covariance_matrix(
        ...
        residual_covariance_func=covariance_matrix_on_residuals_d2,
        jac_fwd=jac_fwd,
        jac_bck=jac_bck,
        dtype=torch.float64
    )
...
set_seed(123)
device = "cpu"
out_dir = Path.cwd() / "RESULTS" / "LIKELIHOODS" / "RESD2"
