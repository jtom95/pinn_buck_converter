...
from .plotting import LaplacePosteriorPlotter, LaplaceDictionaryLoader
from .fitting import LaplacePosterior
from .._general_auxiliaries.plot_aux import place_shared_legend, make_line_with_center_marker_from_dict
...
class LaplaceResultsComparer:
    ...
    def __init__(
        ...
        self.group_number_dict = dict(group_number_dict or {})
    ...
    def from_dirs(
        ...
        group_number_dict: Mapping[int, str],
        ...
        **kwargs,
        ...
        tmp = cls(group_number_dict=group_number_dict,**kwargs)
        if labels is None:
    ...
    def plot_posteriors_grid(
        ...
        for i, name in enumerate(param_names):
            ...
            for lbl in use_labels:
                ...
                marker_dict[f"{prefixes[0]}{lbl}"] = "s"
                # B
                ...
                marker_dict[f"{prefixes[1]}{lbl}"] = "o"
        ...
        if legend:
            place_shared_legend(
                ...
                frameon=legend_frameon,
                legend_bottom_inch=legend_bottom_inch,
                handle_transform=make_line_with_center_marker_from_dict(marker_dict),
            )
