...
from pinn_buck.data_noise_modeling.covariance_matrix_function_archive import covariance_matrix_on_standard_residuals, covariance_matrix_on_delta_residuals
...
covariance_matrices_adc = make_transient_covariance_matrices(
    ...
    residual_covariance_block_func=covariance_matrix_on_delta_residuals,
...
for idx, group_number in enumerate(l_dict.keys()):
    ...
    trainer = Trainer(
        ...
        loss_fn=build_map_loss(
            ...
            loss_likelihood_function=loss_whitened_r_delta,  # loss function for the forward-backward pass
